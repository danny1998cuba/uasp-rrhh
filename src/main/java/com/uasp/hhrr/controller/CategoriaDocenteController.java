...
import com.uasp.hhrr.service.CategoriaDocenteService;
...
public class CategoriaDocenteController {
    ...
    @Autowired
    CategoriaDocenteService service;
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> put(@PathVariable int id, @RequestBody CategoriaDocente input) {
        try {
    ...
    @PostMapping("")
    public ResponseEntity<?> post(@RequestBody CategoriaDocente input) {
        try {
